  ...
  return (
    ...
    >
      <ListItemIcon>
        ...
        <TaskIcon htmlColor={Colors.primary100} />
        <AssignmentIndIcon htmlColor={Colors.primary100} />
        <HandymanIcon htmlColor={Colors.primary100} />
        <EngineeringIcon htmlColor={Colors.primary100} />
      </ListItemIcon>
      <ListItemText style={{ color: Colors.primary100 }} primary={title} />
    </ListItemButton>
  );
};
        ...
        >
          ...
          >
            ...
            <CView className="homeSidebarListItems">
              ...
              <HomeSideListItem title="Empleados" page="employees" />
              <HomeSideListItem title="Configuraciones" page="config" />
            </CView>
